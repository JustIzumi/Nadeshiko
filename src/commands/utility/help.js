...
module.exports.run = async (client, message, args, utils) => {
    ...
    if (!args[1]) {
        ...
        categories.forEach(category => {
            ...
            const fieldTitle = `**${_.capitalize(category)} commands:**`;

            if (commandArray !== '') embed.addField(`${fieldTitle}`, `**${commandArray}**`);
        });

        embed.addField('**\u200b\nAdditional Links**', `**[Server](https://discord.gg/h3cqnn2)** | **[Invite](https://bit.ly/2Irfi0C)**`)
